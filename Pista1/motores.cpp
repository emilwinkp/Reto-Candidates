...
Motores::Motores(uint8_t speed1, uint8_t in1_1, uint8_t in2_1,
  ...
  : motor1(speed1, in1_1, in2_2), motor2(speed2, in1_2, in2_2),
    ...
    encoderPinA2(encoderPinA2), encoderPinB1(encoderPinB2)  // Pines del encoder (modifica según sea necesario)
{
...
void Motores::SetAllSpeeds(uint8_t speed1, uint8_t speed2){
