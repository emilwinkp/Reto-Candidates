...
const int rightMax = 200;
const int leftMax = 200;
const int baseSpeedRight = 100; // Velocidad base para el motor derecho
const int baseSpeedLeft = 105;  
const float Kp = 2.7;
const float Kd = 0.05;
float leftCompensationFactor = 0.7;
int calibracion = 0;
...
void loop() {
  ...
  int rightSpeed = baseSpeedRight + motorSpeed;
  int leftSpeed = (baseSpeedLeft  - motorSpeed) * leftCompensationFactor;
